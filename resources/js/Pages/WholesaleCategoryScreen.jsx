...
function WholesaleCategoryScreen({company,category}) {
  ...
  const [categoryName, setCategoryName] = useState('');
    ...
    const fetchData = (page) => {
        router.get(`/dashboard/${company.company.slug}/wholesale/category`, { page,search }, { preserveState: true });
    };
    ...
    const handleSearch = e => {
        ...
        router.get(`/dashboard/${company.company.slug}/wholesale/category`, {
            search,page:1
        }, {
    ...
    const postCategory = async (event) => {
      ...
      if (categoryName == '') {
          ...
          try {
              router.post('/wholesale/addcategory', {categoryName},
                  {
                      onSuccess: () => {
...
WholesaleCategoryScreen.layout = page => <Layout children={page} props={page.props.company} />
export default WholesaleCategoryScreen