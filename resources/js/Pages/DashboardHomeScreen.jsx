...
function DashboardHomeScreen({
  ...
  console.log(sales_data)
    ...
    const Card = ({ title, value, icon, link, color }) => (
        ...
        <Link
            href={link}
            className={`flex items-center gap-2 px-2 py-4 rounded-xl shadow-md bg-white hover:shadow-xl transition-all border-l-4 ${color}`}
        >
        ...
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            <div className="p-6 space-y-8">
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                    <Card
                        title="Today's Sales"
                        value={`UGX ${Intl.NumberFormat().format(sales_today)}`}
                        link="#"
                        icon="💰"
                    ...
                    />
                       <Card
                        ...
                        value={`UGX ${Intl.NumberFormat().format(
                            Math.abs(profit)
                        )}`}
                        link={`/dashboard/${company.company.slug}/online-portal/orders`}
                        icon={profit >= 0 ? "😃" : "😭"}
                        color={
                            profit >= 0 ? "border-green-700" : "border-red-700"
                        }
                    />
                    <Card
                        title="Out of Stock"
                        value={out_of_stock}
                        link="/inventory/stock/expired"
                        icon="⚠️"
                ...
                <div>
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                        ...
                        {(company.position === "admin" ||
                            ...
                            <Link
                                href={`/dashboard/${company.company.slug}/sales`}
                                className="bg-white p-4 rounded-lg shadow hover:shadow-lg flex flex-col items-center"
                            >
                                <img
                                    src="/images/access/pay.png"
                                    alt=""
                                    className="w-10"
                                />
                        ...
                        {(company.position === "admin" ||
                            company.position === "owner") && (
                            <Link
                                href={`/dashboard/${company.company.slug}/inventory/stock`}
                                className="bg-white p-4 rounded-lg shadow hover:shadow-lg flex flex-col items-center"
                            >
                                <img
                                    src="/images/access/todo.png"
                                    alt=""
                                    className="w-10"
                                />
                        ...
                        {(company.position === "admin" ||
                            company.position === "owner") && (
                            <Link
                                href={`/dashboard/${company.company.slug}/inventory/product`}
                                className="bg-white p-4 rounded-lg shadow hover:shadow-lg flex flex-col items-center"
                            >
                                <img
                                    src="/images/access/product.png"
                                    alt=""
                                    className="w-10"
                                />
                        ...
                        {(company.position === "admin" ||
                            ...
                            company.position === "hr") && (
                            <Link
                                href={`/dashboard/${company.company.slug}/hr/employee`}
                                className="bg-white p-4 rounded-lg shadow hover:shadow-lg flex flex-col items-center"
                            >
                                <img
                                    src="/images/access/company.png"
                                    alt=""
                                    className="w-10"
                                />
                        ...
                        {(company.position === "admin" ||
                            company.position === "owner" ||
                            company.position === "cashier" ||
                            company.position === "dispenser") && (
                            <Link
                                href={`/dashboard/${company.company.slug}/accounting/receipts`}
                                className="bg-white p-4 rounded-lg shadow hover:shadow-lg flex flex-col items-center"
                            >
                                <img
                                    src="/images/access/income.png"
                                    alt=""
                                    className="w-10"
                                />
              ...
              <Link href={`/dashboard/${company.company.slug}/accounting/expenses`} className="bg-white p-4 rounded-lg shadow hover:shadow-lg flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white p-4 rounded-lg shadow w-full h-[350px] flex flex-col">
                        <Typography
                            variant="h6"
                            className="text-center text-indigo-700 mb-2"
                        >
                            Weekly Sales
                        </Typography>
...
DashboardHomeScreen.layout = (page) => (
