...
function EmployeeScreen({ company, employees }) {
    ...
    const fetchData = (page) => {
        router.get(
            `/dashboard/${company.company.slug}/hr/employee`,
            { page, search },
            { preserveState: true }
        );
    };
    ...
    const handleSubmit = async (event) => {
        ...
        if (employeeEmail == "") {
            ...
            try {
                router.post(
                    "/add-employee",
                    { company_id, employeeEmail, position },
                    {
                        onSuccess: () => {
                    ...
                    <form onSubmit={postEdit}>
                        ...
                        >
                            ...
                            <Input
                                ...
                                onChange={(event) =>
                                    setEditEmployeeEmail(event.target.value)
                                }
                                size="sm"
                            />
                            <Select
