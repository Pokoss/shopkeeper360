...
const columns = [
    ...
    {
        name: <b>Price</b>,
        selector: row => Intl.NumberFormat('en-US').format(row.product.retail_price),
        grow: true,
        width: '90px',
        right: true
    },
...
const CustomerBill = forwardRef(( {company, props} ) => {
            ...
            <div className="w-full items-center justify-center space-x-5">
                ...
                <div className="flex flex-col mb-4 items-center">
                    ...
                    <div>
                        ...
                        <div className="font-bold mt-1">CUSTOMER BILL</div>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="text-end pr-5 font-semibold py-2">
                            {/* {facility.currency ?? 'UGX'} 
                            {props.receiptData.total.toLocaleString()} */}
                            {"UGX "+Intl.NumberFormat('en-US').format(parseFloat(props.receipts.sale_total))}
                            </td>
                    </tr>
                        {/* <tr>
