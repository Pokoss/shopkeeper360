                    ...
                    >
                        <ul className="p-2 flex divide-y-1 flex-col md:flex-row items-center justify-center space-y-5 md:flex md:space-x-6 md:space-y-0">
                            ...
                            <li className="text-white">
                                ...
                                >
                                    <MenuHandler >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 hover:text-yellow-500 cursor-pointer">
                                ...
                                >
                                    <MenuHandler>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 mx-5 hover:text-yellow-500 cursor-pointer">
                                ...
                                >
                                    <MenuHandler>
                                        <Avatar className='cursor-pointer' src='/images/user/user.png' alt="avatar" variant="circular" />
                                        {/* <Button variant="gradient" color='white'>{name}</Button> */}
                                    </MenuHandler>
                                    <MenuList>
                                        {
