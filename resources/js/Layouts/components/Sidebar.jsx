...
function Sidebar({ sidebarOpen, setSidebarOpen, props }) {
    ...
    const getAccessibleFeatures = (categorySlug, plan) => {
        ...
        const planBasedFeatures =
            planFeatures[plan?.toLowerCase()] || planFeatures.basic;
            ...
            >
                ...
                <nav className="mt-4 px-2">
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16" />
                        ...
                        {/* POS */}
                        {canAccessByPosition(["owner", "dispenser", "admin"]) &&
                            hasAccess("pos") && (
                                <li>
                                    <Link
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                ...
                                                strokeLinejoin="round"
                                                strokeWidth="2"
                                                d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621a3 3 0 01-.879-2.122V17.25m6-12V15a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 15V5.25m18 0A2.25 2.25 0 0018.75 3H5.25A2.25 2.25 0 003 5.25m18 0V12a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 12V5.25z"
                                            />
                                        </svg>
                                        Point of Sale
                                    </Link>
                        ...
                        {/* Inventory */}
                        {canAccessByPosition(["owner", "admin"]) &&
                            hasAccess("inventory") && (
                        ...
                        {/* Human Resource */}
                        {canAccessByPosition(["owner", "admin", "hr"]) &&
                            hasAccess("hr") && (
                                <li className="transition-all duration-200">
                                    <button
                        ...
                        {/* Online Portal */}
                        {canAccessByPosition(["owner", "admin", "dispenser"]) &&
                        ...
                        {/* Room Management */}
                        {canAccessByPosition(["owner", "admin"]) &&
                            (hasAccess("rooms") || hasAccess("bookings")) && (
                                <li className="transition-all duration-200">
                                    <button
                        ...
                        {/* Messaging - Available to all businesses */}
                        <li className="transition-all duration-200">
                            <Link
                                href={`/dashboard/${props.company.slug}/messaging/sms`}
                                className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-gray-200 hover:bg-secondary hover:text-white transition-all duration-200"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
